...
class NagaCamera(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(max_length=10)
    alert = models.IntegerField()
    shop = models.ForeignKey('NagaShop', models.DO_NOTHING)
...
class NagaImage(models.Model):
    id = models.BigAutoField(primary_key=True)
    imgurl = models.CharField(db_column='imgUrl', max_length=255)  # Field name made lowercase.
    camera = models.ForeignKey(NagaCamera, models.DO_NOTHING)
